...
import ImgGirl from "./asset/img/matthew-hamilton-tNCH0sKSZbA-unsplash.jpg";
...
const Home = () => {
  return (
    <div className="home-background pb-5">
      <header>
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-8 col-md-12 col-sm-12 col-12">
              <div class="alterra">
                <a href="index.html">
                  <img class="logo-atas" src={LogoAlta} alt="LogoAlta" />
                </a>
              </div>
            </div>
      ...
      <div class="container h-100">
        <div class="row align-items-center isi-home">
          <div class="col-lg-4 col-md-12 col-sm-12 col-12">
            <img id="foto-profil" src={ImgGirl} alt="ImgGirl" />
          </div>
          <div class="col-lg-8 col-md-12 col-sm-12 col-12">
            <div class="main-p">
